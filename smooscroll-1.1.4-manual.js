...
document.addEventListener('DOMContentLoaded', function () {
    ...
    const config = {
        ...
        //回到顶部按钮配置
        buttonImage: "https://shuninyu.github.io/SmooScroll/top-circle.svg",  // 按钮图片路径
        renderStyle: "normal", // 如果你的按钮图片是原尺寸像素图 改为pixelated
        buttonWidth: "5vw", // 按钮宽度
        buttonHeight: "5vw", // 按钮高度
        positionRight: "2vw", // 按钮定位 距离窗口右侧的宽度
        positionBottom: "2vw", // 按钮定位 距离窗口底部的高度
